...
export default function TrustBadges() {
  return (
    <div className="border-t border-gray-100 py-10 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4">
        {ITEMS.map(item => (
          <div key={item.label} className="flex flex-col items-center text-center gap-3">
            ...
            <div className="flex flex-col gap-0.5">
              <p className="text-[11px] uppercase tracking-[0.15em] text-black font-semibold">
                {item.label}
              </p>
